  ...
  return (
    <section className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-10 px-4 flex flex-col items-center">
        ...
        >
          <span className="block text-[clamp(4rem,18vw,10rem)] text-glow text-purple-400">
            REV &amp;
          </span>
          <span className="block text-[clamp(4rem,18vw,10rem)] text-white" style={{ marginTop: "-0.1em" }}>
            RINSE
          </span>
          <span
        ...
        {/* Divider */}
        <div className="mt-5 mb-5 flex items-center gap-3 w-72">
